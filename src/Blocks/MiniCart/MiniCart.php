<?php
/**
 * MiniCart Block - Tương thích với WooCommerce CSS
 * 
...
class MiniCart extends AbstractBlock {
    protected $block_name = 'jankx/mini-cart';
    protected $description = 'Hiển thị giỏ hàng mini';
    protected $keywords = ['cart', 'mini-cart', 'jankx', 'woocommerce'];
    ...
    public function render($attributes, $content) {
        ...
        <div class="<?php echo esc_attr(implode(' ', $wrapper_classes)); ?>">
            <!-- MiniCart content here -->
            <div class="jankx-block-mini-cart-content">
                <p>Jankx MiniCart Block - Tương thích với WooCommerce CSS</p>
            </div>
        </div>
        <?php
        return ob_get_clean();
