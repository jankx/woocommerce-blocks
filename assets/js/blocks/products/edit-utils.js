...
export const renderNoProductsPlaceholder = ( blockTitle, blockIcon ) => (
	...
	>
		...
		<Button
			className="jankx-block-products__add-product-button"
			variant="secondary"
			href={ ADMIN_URL + 'post-new.php?post_type=product' }
			target="_top"
		>
			{ __( 'Add new product', 'jankx-woocommerce-blocks' ) + ' ' }
			<Icon icon={ external } />
		</Button>
		<Button
			className="jankx-block-products__read_more_button"
			variant="tertiary"
			href="https://docs.woocommerce.com/document/managing-products/"
			target="_blank"
		>
			{ __( 'Learn more', 'jankx-woocommerce-blocks' ) }
		</Button>
	</Placeholder>
);
